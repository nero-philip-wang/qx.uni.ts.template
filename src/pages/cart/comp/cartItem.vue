<template>
  <div class="flex px-32 py-16 place-items-center bg-white" style="z-index:100">
    <!-- 勾选 -->
    <div v-if="showCheckbox" class="flex place-items-center pr-16 itemheight" @click="checkedTriggle">
    ...
    <!-- 图片 -->
    <div>
      <u--image show-loading :src="cover" width="200rpx" height="200rpx"></u--image>
    </div>
    <!-- 右侧文本 -->
    <div class="flex-grow flex-col ml-16 itemheight">
      <!-- 标题 -->
      <u--text :lines="2" :text="title" bold size="28rpx" line-height="44rpx"></u--text>
      <!-- 规格 -->
      <div class="text-sm flex-grow"> 默认规格 {{ JSON.stringify(checked) }} </div>
      <!-- 价格数量 -->
      <div class="flex lineh-full">
