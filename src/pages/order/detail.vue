  ...
  <view class="app">
    <view class="main-wrap" :class="{ show: loaded }">
      ...
      <view class="addr-sec">
        ...
        <view class="con column">
          <text class="addr">{{ data.consignee.address }} </text>
          <text class="name">{{ data.consignee.name }} {{ data.consignee.mobile }}</text>
        </view>
      </view>
      <!-- 商品 -->
      <view v-if="data.items.length > 0" class="goods-sec">
        <product-list :list="data.items"></product-list>
      </view>
      <!-- 价格信息 -->
      <view class="price-sec">
        ...
        <view class="cell row">
          ...
          <text>-￥{{ data.promotionDiscount || 0 }}</text>
        </view>
        <view class="cell row">
          <text class="tag red">券</text>
          <text class="tit fill">优惠券</text>
          <text>-￥{{ data.couponDiscount || 0 }}</text>
        </view>
        <!-- <view class="cell row">
        ...
        <view class="total row b-t">
          <text class="price">￥{{ data.freightAmount || 0 }}</text>
        </view> -->
      </view>
      <view class="board">
        <view class="cell">
          ...
          <!-- #ifndef H5 -->
          <view class="copy-btn center round" @click="copy(data.id)">
            <text>复制</text>
          </view>
          <!-- #endif -->
        </view>
        <view class="cell">
          ...
          <text class="text">{{ data.creationTime | timef }}</text>
        </view>
        ...
        <view v-if="data.buyerRemark" class="cell">
          <text class="tit">订单备注：</text>
          <text class="text">{{ data.buyerRemark }}</text>
        </view>
      </view>
